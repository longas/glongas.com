export default function Footer() {
  return (
    <footer className="mt-14 lg:mt-24">
      <div className="flex justify-center space-x-6">
        <a
          className="text-gray-600 hover:text-glongas-green transition-colors"
        ...
        <a
          className="text-gray-600 hover:text-glongas-green transition-colors"
          href="https://www.linkedin.com/in/glongas/"
          target="_blank"
          rel="noopener noreferrer"
          title="LinkedIn"
        >
